...
class BatchedAgiSimEnv(py_environment.PyEnvironment):
    ...
    def _split_observation(self, obs_batch_flat):
    ...
    def _reset(self):
        ...
        self._perform_initial_batch_reset()
        structured_initial_observations = self._split_observation(self._next_obs_for_first_step_raw)
    ...
    def _step(self, action_batch: np.ndarray):
        ...
        # --- NEW: Create an array to hold the success flags ---
        ...
        structured_s_prime_observations = self._split_observation(s_prime_raw_observations_float64)
