...
private:
    struct DroneData {
        agi::Vector<3> target_start_p{agi::Vector<3>::Zero()};
    ...
    double capture_radius_{5.0};
    double max_episode_time_s_{30.0};

    double distance_scale_{0.6};
    double dist_delta_scale_{2.5};
    double vel_closing_scale_{0.0};
    double time_penalty_per_step_{0.0};

    double success_reward_{300.0};
    double crash_penalty_{-30.0};
